...
class MensajesController
{
    ...
    /**
     * Igual que getMensajes(), pero solo trae los mensajes con id mayor a
     * $ultimoId. Pensado para el polling corto del frontend: en vez de
     * volver a traer y re-renderizar toda la conversación cada pocos
     * segundos, solo se pide "lo nuevo desde el último mensaje que ya vi".
     * Funciona tanto con el esquema nuevo de conversaciones (participante_1/2)
     * como con el legacy (paciente_id/especialista_id), porque en ambos
     * casos los mensajes viven en la misma tabla mensajes_chat.
     */
